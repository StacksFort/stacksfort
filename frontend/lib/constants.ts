...
export const TOKEN_CONTRACT_FULL = `${DEPLOYER}.${TOKEN_CONTRACT_NAME}`;

// Legacy support (if needed by existing code structure)
export const CONTRACT_ADDRESS = DEPLOYER;
export const CONTRACT_NAME = MULTISIG_CONTRACT_NAME;
